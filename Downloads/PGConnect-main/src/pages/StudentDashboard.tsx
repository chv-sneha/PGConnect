...
const StudentDashboard = () => {
  ...
  const calculateCompatibility = (user1Prefs: any, user2Prefs: any) => {
    let totalScore = 0;
    let weights = {
      food: 25,
      sleep: 20, 
    ...
    // Noise tolerance compatibility (15 points)
    ...
    // Lifestyle habits compatibility (5 points)
    let habitScore = 0;
    ...
    switch (currentStep) {
      case 1:
        if (!userPreferences.foodHabits || !userPreferences.sleepSchedule || 
          ...
          alert('⚠️ Please fill all lifestyle preferences before continuing!');
          return false;
        }
        break;
      case 2:
        if (!userPreferences.studyHabits) {
          alert('⚠️ Please select your study habits before continuing!');
          return false;
        }
        break;
      case 3:
        if (!userPreferences.personality || userPreferences.hobbies.length === 0) {
          alert('⚠️ Please select your personality type and at least one hobby!');
          return false;
        }
        break;
      case 4:
        if (!userPreferences.sharingPreference || !userPreferences.guestPolicy) {
          alert('⚠️ Please complete all additional preferences!');
          return false;
        }
        break;
    }
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <header className="bg-card border-b sticky top-0 z-50 backdrop-blur-lg bg-card/95">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <Button className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white" onClick={handleFindMyMatch}>
                    ...
                    <Card className="p-6 border-2 hover:border-blue-300 transition-all duration-300">
                      ...
                      <RadioGroup value={userPreferences.foodHabits} onValueChange={(value) => handlePreferenceChange('foodHabits', value)} className="space-y-3">
                        ...
                        <div className="flex items-center space-x-3 p-3 rounded-lg hover:bg-blue-50 transition-colors cursor-pointer">
                          ...
                          <Label htmlFor="both" className="cursor-pointer flex-1">🍽️ Both (Flexible)</Label>
                        </div>
                      </RadioGroup>
                    </Card>
                  ...
                  <Card className="p-6 border-2 hover:border-blue-300 transition-all duration-300">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {[
                        ...
                        { name: 'Travel', icon: '✈️', color: 'hover:bg-cyan-50' },
                  ...
                  <Card className="p-6 border-2 hover:border-blue-300 transition-all duration-300">
                    ...
                    <RadioGroup value={userPreferences.personality} onValueChange={(value) => handlePreferenceChange('personality', value)} className="space-y-3">
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-lg hover:bg-green-50 transition-colors cursor-pointer">
                        ...
                        <Label htmlFor="balanced" className="cursor-pointer flex-1">⚖️ Balanced</Label>
                      </div>
                    </RadioGroup>
                  </Card>
                </div>
